  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="text-sm text-muted">Full agent run history and pipeline stats — the operational log.</p>
      </div>
            ...
            {(!runs || runs.length === 0) && (
              <tr>
                <td colSpan={6} className="px-4 py-6 text-center text-muted">
                  No runs yet — click &ldquo;Run now&rdquo; on the Dashboard to trigger the pipeline.
                </td>
              </tr>
            )}
          </tbody>
